...
public class EntityUtil {
    ...
    private final String service_package = "net.menwei.service";
    private final String service_impl_package = "net.menwei.service.impl";
...
//    private final String password = "admin";
    ...
    public static void main(String[] args) {
        try {
             ...
             */
            List<String> customizeTables = new ArrayList<String>();
//            customizeTables.add("tb_daily_info");
//            customizeTables.add("tb_mode");
...
//        bw.write("import org.apache.ibatis.annotations.Param;");
    ...
    private void buildSQL(BufferedWriter bw, List<String> columns, List<String> types) throws IOException {
        ...
        bw.write("\t<select id=\"selInfo\" resultType=\""
                + processResultMapId(beanName) + "Dto" + "\">");
        bw.newLine();
        bw.write("\t\t SELECT");
        bw.newLine();
        ...
        bw.newLine();
        bw.write("\t<delete id=\"del\" parameterType=\"" + processResultMapId(beanName) + "Dto" + "\">");
        bw.newLine();
        ...
        bw.write("\t<!-- 添加 -->");
        bw.newLine();
        bw.write("\t<insert id=\"add\" parameterType=\"" + processResultMapId(beanName) + "Dto" + "\" keyColumn=\"" + processField(columns.get(0)) + "\" useGeneratedKeys=\"true" + "\">");
        bw.newLine();
        ...
        bw.write("\t<!-- 修 改-->");
        bw.newLine();
        bw.write("\t<update id=\"edit\" parameterType=\"" + processResultMapId(beanName) + "Dto" + "\">");
        bw.newLine();
...
//        bw.newLine();
        ...
        bw.newLine();
        bw.write("\t");
        bw.write("public ResultSet methodName(HttpServletRequest request) {");
        bw.newLine();
        bw.newLine();
        bw.write("\t");
        bw.write("\t");
